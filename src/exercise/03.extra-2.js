...
function PokemonInfo({pokemonName}) {
  // could be extracted into a custom usePokemonCache hook and reused in PreviousPokemon compoentn
  ...
  return (
    <div style={{display: 'flex'}}>
      <PokemonCacheProvider>
        {/* needs context value given by PokemonCacheProvider*/}
        ...
        <div className="pokemon-info" style={{marginLeft: 10}}>
          ...
          >
            {/* also needs context value given by PokemonCacheProvider */}
